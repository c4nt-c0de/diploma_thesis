...
src folder contains the individual parts which I chose to save. I'm particularly fond of the U-Time implementation and the non-parametric cluster based statistical methods.
